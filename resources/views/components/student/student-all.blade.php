            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    ...
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        Manage <strong>Students</strong> in your school
                    </h2>
                </div>
                ...
                @if(session('student'))
                    <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                        <div class="alert alert-secondary alert-dismissible alert-success" role="alert">
                            <p class="mb-0">
                                {{ session()->get('student') }} <a class="alert-link" href="{{ route('timeslot.all') }}">OK</a>!
                            </p>
            ...
            <div class="col-sm-6 col-xl-4" style="margin-left: 77%">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-light" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(0px, -39px, 0px);" data-popper-placement="top-start">
                        <a class="dropdown-item" href="{{ route('student.all', ['sortBy' => 'name', 'orderBy' => 'asc']) }}">Name - asc</a>
                        <a class="dropdown-item" href="{{ route('student.all', ['sortBy' => 'name', 'orderBy' => 'desc']) }}">Name - dsc</a>

                        <a class="dropdown-item" href="{{ route('student.all', ['sortBy' => 'active', 'orderBy' => 'desc']) }}">Status - enabled</a>
                        <a class="dropdown-item" href="{{ route('student.all', ['sortBy' => 'active', 'orderBy' => 'asc']) }}">Status - disabled</a>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <form action="{{ route('student.remove', ['id' => $student->id]) }}" method="POST">
