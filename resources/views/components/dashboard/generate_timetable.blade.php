                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-x-0">
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="" id="all-venues" >
                                        <label class="form-check-label" for="all-venues">Available Venues</label>
                                    </div>
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input venue" type="checkbox" value="" id="example-switch-inline2" name="example-switch-inline2">
                                        <label class="form-check-label" for="example-switch-inline2">Venue 1</label>
                                    </div>
                        ...
                        <div class="col-lg-8 col-xl-8">
                            ...
                            <div class="mb-4" id="courses" style="display: none">
                                ...
                                <div class="space-x-0">
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input venue" type="checkbox" value="" id="example-switch-inline2" name="example-switch-inline2">
                                        <label class="form-check-label" for="example-switch-inline2">course 1</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-x-0">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input venue" id="time-slots" type="checkbox" value="" name="time-slots">
                                        <label class="form-check-label" for="time-slots">8:00AM - 10:00AM</label>
                                    </div>
