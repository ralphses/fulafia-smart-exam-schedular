...
<main id="main-container">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    ...
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        Update an existing department for your school
                    </h2>
                </div>
    ...
    <div class="content">
        ...
        <form class="js-validation" action="{{ route('department.update', $department->id) }}" method="POST">
                            ...
                            <div class="form-floating mb-4">
                                ...
                                <div class="form-floating mb-4">
                                    <select class="form-select" id="example-select-floating" name="department-status" aria-label="Floating label select example">
                                        <option selected value=" {{ $department->status ? '0' : '1' }}">{{ $department->status ? 'Disable' : 'Enable' }}</option>
