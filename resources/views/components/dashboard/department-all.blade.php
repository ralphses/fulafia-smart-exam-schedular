                ...
                @if(session('departments'))
                    <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                        <div class="alert alert-secondary alert-dismissible alert-success" role="alert">
                            <p class="mb-0">
                                {{ session()->get('departments') }} <a class="alert-link" href="{{ route('dashboard') }}">OK</a>!
                            </p>
            ...
            <div class="col-sm-6 col-xl-4" style="margin-left: 77%">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-light" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(0px, -39px, 0px);" data-popper-placement="top-start">
                        <a class="dropdown-item" href="{{ route('department.all', ['sortBy' => 'name', 'orderBy' => 'asc']) }}">Name - asc</a>
                        <a class="dropdown-item" href="{{ route('department.all', ['sortBy' => 'name', 'orderBy' => 'desc']) }}">Name - dsc</a>

                        <a class="dropdown-item" href="{{ route('department.all', ['sortBy' => 'active', 'orderBy' => 'desc']) }}">Status - enabled</a>
                        <a class="dropdown-item" href="{{ route('department.all', ['sortBy' => 'active', 'orderBy' => 'asc']) }}">Status - disabled</a>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('department.update', ['id' => $department->id]) }}">
                                        ...
                                        <form action="{{ route('department.status', ['id' => $department->id]) }}" method="POST">
