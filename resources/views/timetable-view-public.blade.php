            ...
            <div class="content-header bg-white-5">
                ...
                <a class="fw-semibold text-dual" href="{{ '/' }}">
                    ...
                    <span class="smini-hide fs-5 tracking-wider">
                        FUL<span class="fw-normal">afia</span>
                    </span>
                </a>
                <!-- END Logo -->
            ...
            <div class="content-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="fw-semibold fs-5 tracking-wider text-dual me-3" href="/">
                        FULAFIA TIMETABLE MANAGEMENT<span class="fw-normal"></span>
                    </a>
                    <!-- END Logo -->
                </div>
                <!-- END Left Section -->
        ...
        <main id="main-container">
            ...
            <div class="content">
                ...
                @if ($schedules->count() > 0)
                    <!-- md Grid -->
                    <h2 class="content-heading text-center">Student Schedular
                        {{ '(' . $schedules->first()->student_matric . ')' }}</h2>
                    <div class="row text-left">

                        @foreach ($schedules as $schedule)
                            <div class="col-md-3">
                                <div class="block block-rounded py-3 px-3">
                                    <div class="block-content">
                                        <p class="fw-medium mb-0">SEAT NO: {{ $schedule->seat_no }}</p>
                                        <p class="fw-medium text-muted mb-0">COURSE: {{ $schedule->course_code }}</p>
                                        <p class="fw-medium text-muted mb-0">VENUE: {{ $schedule->venue }}</p>
                                        <p class="fw-medium text-muted mb-0">DATE: {{ $schedule->exam_date }}</p>
                                        <p class="fw-medium text-muted mb-0">TIME: {{ $schedule->time_slot }}</p>
                    ...
                    <h2 class="content-heading text-center">Main TimeTable</h2>
                @endif
                ...
                @foreach (explode('|', $timetable->instructions) as $instruction)
                    <p class="text-sm-start" style="margin: auto; font-size: smaller">
                        {{ ++$loop->index . '. ' . $instruction }}</p>
                @endforeach
                ...
                <strong>
                    <h6 class="text-sm-end" style="margin: auto;">{{ $timetable->planner }}</h6>
                </strong>
                <i>
                    <h6 class="text-sm-end" style="margin: auto;">Timetable Officer</h6>
                </i>
